...
class BusinessFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.recyclerViewOfBooks.layoutManager = LinearLayoutManager(context)
        binding.recyclerViewOfBooks.adapter = adapter
    ...
    private fun findNews() {
        ...
        retrofitData.getCategory("in", "business", 50, apiKey).enqueue(object : Callback<MainData?> {
