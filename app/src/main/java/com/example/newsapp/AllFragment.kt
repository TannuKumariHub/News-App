...
import com.example.newsapp.databinding.FragmentAllBinding
...
class AllFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.recyclerViewOfAll.layoutManager = LinearLayoutManager(context)
        binding.recyclerViewOfAll.adapter = adapter
    ...
    private fun findNews() {
        ...
        retrofitData.getAllData("in", 20, apiKey).enqueue(object : Callback<MainData?> {
