...
class ScienceFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.recyclerViewOfPaidEbooks.layoutManager = LinearLayoutManager(context)
        binding.recyclerViewOfPaidEbooks.adapter = adapter
    ...
    private fun findNews() {
        ...
        retrofitData.getCategory("in", "science",20, apiKey).enqueue(object : Callback<MainData?> {
