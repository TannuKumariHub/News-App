...
class TechnologyFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.recyclerViewOfEbooks.layoutManager = LinearLayoutManager(context)
        binding.recyclerViewOfEbooks.adapter = adapter
    ...
    private fun findNews() {
        ...
        retrofitData.getCategory("in","technology", 20, apiKey).enqueue(object : Callback<MainData?> {
